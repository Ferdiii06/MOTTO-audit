    ...
    public function run(): void
    {
        ...
        $areas5s = [
            ...
            [
                'slug' => 'pre-assy-drums',
                'name' => 'Pre Assy - Drums',
                'description' => 'Persiapan perakitan awal komponen drum wiring',
        ...
        // 2. Seed Change Point Area & EXACTLY 2 processes ("Cutting & Crimping" and "Assembly Process")
        ...
        AuditProcess::updateOrCreate(
            ['audit_area_id' => $changePointArea->id, 'name' => 'Cutting & Crimping'],
            [
                'description' => 'Audit manajemen perubahan pada proses pemotongan & pengkeriman kabel',
                'status' => 'Ready',
                'sort_order' => 1,
            ]
        );
        ...
        AuditProcess::updateOrCreate(
            ['audit_area_id' => $changePointArea->id, 'name' => 'Assembly Process'],
            [
                'description' => 'Audit manajemen perubahan pada proses perakitan utama',
                'status' => 'Ready',
                'sort_order' => 2,
            ]
        );

        // 3. Seed License System Area & EXACTLY 1 process ("All Process")
        ...
        AuditProcess::updateOrCreate(
            ['audit_area_id' => $licenseSystemArea->id, 'name' => 'All Process'],
            [
                'description' => 'Pemeriksaan dan evaluasi lisensi sertifikasi operasional seluruh proses',
                'status' => 'Ready',
                'sort_order' => 1,
            ]
        );
